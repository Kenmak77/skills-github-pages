...
document.addEventListener("DOMContentLoaded", () => {
  const translations = {
    en: {
      ...
      "summary-text3": "<u>Current version: P+FR 1.5.2, P+ 3.1.5 (04/22/2026)</u>",
      "summary-text4": "5 GB minimum required",
    ...
    fr: {
      ...
      "summary-text3": "<u>Version actuelle : P+FR 1.5.2, P+ 3.1.5 (22/04/2026)</u>",
      "summary-text4": "5 Go d’espace disque minimum requis",
